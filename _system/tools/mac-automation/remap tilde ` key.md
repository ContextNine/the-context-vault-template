...
The current managed workflow is documented in [[_system/tools/mac-automation/README|macOS Automation]] and configured by [[_system/agents/edit/settings/skills/config/fleet-i-code-folder-and-computer-topology/Mac Startup/README|macOS Startup Configuration]]. Use:
