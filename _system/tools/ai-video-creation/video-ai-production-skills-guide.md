...
- [[_system/agents/edit/skills/_video/video-ai-production/SKILL|video-ai-production]]
- [[_system/agents/edit/skills/_video/video-elevenlabs-voiceover/SKILL|video-elevenlabs-voiceover]]
- [[_system/agents/edit/skills/_video/video-heygen-avatar-render/SKILL|video-heygen-avatar-render]]
- [[_system/agents/edit/skills/_video/video-hyperframes-motion-graphics/SKILL|video-hyperframes-motion-graphics]]
- [[_system/agents/edit/skills/_video/video-ffmpeg-video-assembly/SKILL|video-ffmpeg-video-assembly]]
- [[_system/agents/edit/skills/_video/video-qa-review/SKILL|video-qa-review]]
...
```bash
node .agents/skills/video-ai-production/scripts/chunk-script.js script.md --out raw-media/voice/chunks.json
node .agents/skills/video-ai-production/scripts/build-manifest.js --project . --out renders/manifest.json
bash .agents/skills/video-ai-production/scripts/check-video-props.sh renders/final.mp4
bash .agents/skills/video-ai-production/scripts/extract-qa-frames.sh renders/final.mp4 qa/frames
```

## Detailed Overview

`video-ai-production` is the main orchestration skill. It turns a prompt and source folder into a staged production workflow: brief, source proof, script, voice, avatar, motion graphics, assembly, and QA.
...
4. `video-hyperframes-motion-graphics`
