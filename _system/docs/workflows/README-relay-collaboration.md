...
1. Run public Context9 vault setup from root `README.md`.
...
- Shared folder remains operating/source-of-truth space for everyone connected to it.
- Private context stays outside shared folder.
