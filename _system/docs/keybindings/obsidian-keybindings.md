...
| `Cmd+2` | Context Nine: focus first main pane | Main editor pane 1 in the left/main/right navigation cluster. |
| `Cmd+3` | Context Nine: focus second main pane | Main editor pane 2; creates a second vertical pane if needed. |
| `Cmd+4` | Context Nine: focus right sidebar | Expands and focuses the right sidebar. |
...
| `!important` | Priority alias added by Context Nine; creates priority `high`. |
