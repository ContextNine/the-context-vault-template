...
- `_system/agents/skills/<_group>`: canonical Vault-owned sources. `-i-` and invocation metadata must agree.
- `_system/agents/skills/github/<repo-name>/skills`: publisher-managed `gh skill` installs.
- `_system/agents/skills/overlays`: generated linked policy views.
- `_system/agents/skills/snapshots`: generated prefixed copies.
