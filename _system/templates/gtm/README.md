...
The business teamspace pack at `_system/templates/teamspaces/business/` composes this GTM component for new teamspaces. `$vault-i-use-crm` adds missing files to existing teamspaces without replacing their edits. The personal-brand pack keeps its marketing work under `brand/` and does not copy the company GTM scaffold.
