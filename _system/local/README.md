...
```text
_system/agents/edit/settings/skills/config/<skill-name>/
...
Public export excludes every `_system/agents/edit/settings/skills/config/**/private/**` path, `_system/local/snippets/private/**`, all `_system/local/env/**` contents, and `_system/local/state/**`. Public skills must handle missing private config with setup guidance.
