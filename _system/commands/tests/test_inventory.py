...
class InventoryTests(unittest.TestCase):
    def test_inventory_reads_live_sources_without_writing(self) -> None:
        ...
        self.assertEqual(result["default_capture_teamspace"], "personal")
        self.assertEqual(result["active_periods"]["weekly"], "2026-W30")
        self.assertEqual(result["teamspaces"][0]["note_path"], "personal/personal.md")
        self.assertEqual(result["teamspaces"][0]["features"], ["blog"])
        self.assertTrue(result["teamspaces"][0]["periodic_notes_enabled"])
        self.assertTrue(result["teamspaces"][0]["content_schedules_enabled"])
        self.assertTrue(result["teamspaces"][0]["periodic_notes"]["daily"]["exists"])
