...
def build_parser() -> argparse.ArgumentParser:
    ...
    unconfigure_mode = unconfigure.add_mutually_exclusive_group()
    unconfigure_mode.add_argument("--dry-run", action="store_true")
    unconfigure_mode.add_argument("--apply", action="store_true")
